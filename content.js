...
const experienceMedia = {
  ...
  "04": [
    ...
    { src: "images/experience/oldrover.jpg", alt: "University of Guelph Robotics Team rover", caption: "An earlier University of Guelph rover platform integrating the team’s mechanical, electrical, sensing, and control systems." }
  ],
  "05": [
...
const pages = {
  home: `
    <header class="portfolio-header" id="home">
      ...
      <div class="hero-copy">
        ...
        <h1>Haris Zubair</h1>
        <p class="portfolio-title">Embedded systems, hardware design &amp; AI software engineering</p>
      </div>
    ...
    <div class="home-overview">
      <section class="portfolio-panel">
        ...
        <div class="panel-content">
          ...
          embedded firmware, robotics, and engineering AI systems. I'm currently seeking a  co-op/internship position for Summer 2027 withing the hardware/electrical/electronics domain, feel free to conatact me if you'd like to learn more about me. Thank you!</p>
          <p class="home-facts">3.7 GPA &middot; Dean's Honour List &middot; Expected graduation May 2028</p>
        </div>
      </section>
      <section class="portfolio-panel">
        <div class="panel-title">Technical Skills</div>
    ...
    <div class="home-directory">
      ...
      <a class="directory-card home-extra-link" href="skills.html">
        ...
        <span><b>Technical Skills</b><small>Hardware, programming, tools</small></span>
      </a>
      ...
      <a class="directory-card" href="contact.html">
        <span class="directory-icon" aria-hidden="true">✉️</span>
        <span><b>Contact</b><small>Email, LinkedIn, résumé</small></span>
      </a>
    </div>
  ...
  experience: `
    ${sharedNav}
    ${pageHeader("Experience", "Engineering in research and industry", "Roles spanning AI product development, assistive robotics, medical imaging, rover electronics, and technical community leadership.")}
    <div class="experience-list">
      ${experience("00", "Future Engineering Intern at Your Company", "Your Company · This could be us", "Available May 2027", ["Available for a Summer 2027 engineering internship or co-op beginning in May.", "Ready to contribute across embedded systems, PCB design, robotics, test engineering, FPGA development, or engineering-focused AI software.", "Brings hands-on experience taking ideas from schematic and code through integration, testing, debugging, and clear technical documentation.", "Your company logo and some excellent project photos could occupy this slideshow. Convenient, right?"], ["Available May 2027", "Embedded Systems", "Hardware", "Robotics", "FPGA", "AI Software"], [{type: "placeholder", text: "Image loading indefinitely..."}])}
  ...
  contact: `
    ${sharedNav}
    ${pageHeader("Contact", "Let's build something physical", "I am interested in embedded systems, electrical design, robotics, and AI software opportunities.")}
