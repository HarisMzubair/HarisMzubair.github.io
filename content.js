...
const project = (number, title, date, description, tags, images = [], highlights = []) => `
  <article class="project-detail">
    ${images.length ? `<div class="project-media" aria-label="Image placeholders for ${title}">
...
const pages = {
  ...
  projects: `
    ...
    <div class="project-page-grid">
      ${project("08 / HARDWARE", "Custom Desktop PC Build", "March 2026", "Sourced the parts and independently assembled a compact desktop PC, comparing prices across sellers to find the best deals. Built the system around an AMD Ryzen 5 5600, a Gigabyte B550I AORUS PRO AX motherboard, and 32 GB of RAM, running Windows 11 Pro.", ["PC Assembly", "Component Sourcing", "Windows 11 Pro"], [{src: "images/PCbuild/mainimgpc.png", alt: "Completed custom desktop PC in a black Cooler Master case", caption: "Completed compact desktop PC, independently sourced and assembled in March 2026."}, {src: "images/PCbuild/insidepc.png", alt: "Interior of the custom PC showing an MSI GeForce RTX graphics card and case fans", caption: "Interior layout showing the MSI GeForce RTX graphics card and case fans."}, {src: "images/PCbuild/newthermalpasteapplied.png", alt: "PC motherboard with CPU cooler, memory, and internal cabling", caption: "Close-up of the CPU cooler, memory, and internal connections during the build."}], ["Compared component prices across sellers and sourced parts individually to get the best available prices.", "Assembled the complete system myself, integrating the motherboard, processor, memory, graphics card, cooling, and internal connections in a compact case.", "System specifications: AMD Ryzen 5 5600 at 3.5 GHz with 6 cores and 12 threads, Gigabyte B550I AORUS PRO AX motherboard, 32 GB RAM, and Windows 11 Pro."])}
...
if (portfolioRoot && pages[currentPage]) {
  ...
  if (currentPage === "projects") {
    ...
    document.querySelectorAll(".project-detail").forEach((card, index) => {
      if (!card.querySelector(".project-copy")) {
